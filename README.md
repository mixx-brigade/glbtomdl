...
glbtommdl is a tool used to convert gLTF GLB files to Valve MDL files. This tool was/is written for the MIXX Brigade branch of Source 2013. 

### Usage
This will be documented once the tool is in a "ready" state.
